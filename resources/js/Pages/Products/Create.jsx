            ...
            <div className="max-w-2xl mx-auto">
                <form onSubmit={submit} className="card p-6 space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            <label className="block text-xs font-medium text-steel uppercase tracking-wider mb-1">Foto</label>
                        ...
                        <div>
                            <label className="block text-xs font-medium text-steel uppercase tracking-wider mb-1">Stok Awal <span className="text-red-500">*</span></label>
